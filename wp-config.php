 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'T%U[!c4#Rc$(r(zswQD<N.ObAyr7OQDn%(1eNekT+xJ4,.{D~v-dG[GqPt7N,M7_');
define('SECURE_AUTH_KEY',  'jxSSiZOG|/&,0 e;LS@1SxPn4X[D5t$QxpOo>~Se!WMF|&y6XQ+|FgW]L-b$j2:*');
define('LOGGED_IN_KEY',    'F{t<i:/t]gC|hvwb{{/Ez=eCM=E1P<<d.LlIvTK!|;jR^cJqNu1{#v5LsDu$-)g,');
define('NONCE_KEY',        '*RE^z]Wz4Zu`v:_T;j_nX6v|#HaF,&{G.O/$I_K-zE}x4-S7gN__lIl4Ho>>QA{|');
define('AUTH_SALT',        'hKxdxEtb_^>97|S}^q<!acB?pA7+*h@-H^G5FB[.`-_|X;1PMa9R4Vg73n5q&4pJ');
define('SECURE_AUTH_SALT', 'W*7t;XY+>NTZQuJQ`]zH5I-<}w#cUGJSuN{ICF7NqA=s@/7=+|YjyD|KE/#U3|}M');
define('LOGGED_IN_SALT',   ';]:MZ8^<,M#6uF%m%E-<:CDlA89#4)$q{+o,W[DcbaqJCy~&U=3jo,b;(9;UP+Ls');
define('NONCE_SALT',       '//<` lg4%)$;)2EUMwoA$3)N-ix(c8`@9!#hSX#8l%?N+-rG5kY7|Z+[yPxm`_82');
