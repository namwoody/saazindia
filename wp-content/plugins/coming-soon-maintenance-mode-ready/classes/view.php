...
abstract class viewCsp extends baseObjectCsp {
    /* 
     * @deprecated
     */
    protected $_tpl = CSP_DEFAULT;
    /*
	...
	public function getPath($tpl) {
		...
		$plTemplate = frameCsp::_()->getModule('options')->get('template');		// Current plugin template
	...
	public function getModule() {
		return frameCsp::_()->getModule( $this->_code );
	}
	public function getModel() {
		return frameCsp::_()->getModule( $this->_code )->getController()->getModel();
	}
