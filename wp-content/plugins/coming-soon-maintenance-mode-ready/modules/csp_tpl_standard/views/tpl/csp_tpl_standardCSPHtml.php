...
<html <?php language_attributes(); ?>>
	...
	<body>
        ...
        <div class="cspHtmlContainerWrapper">
            ...
            <?php echo $this->countDownTimerHtml;?>
			<div style="clear: both;"></div>
